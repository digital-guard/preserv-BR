...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952077,'carlos',952077,'+proj=longlat +datum=WGS84 +no_defs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952077"
cd /tmp/sandbox/_pk7600009101_001; shp2pgsql -D   -s 952077 "levels_3Polygon.shp" pk7600009101101_p1_block | psql -q postgres://postgres@localhost/ingest1 2> /dev/null
...
psql postgres://postgres@localhost/ingest1 -c "DROP  TABLE IF EXISTS pk7600009101101_p1_block CASCADE"
@echo "Delete SRID 952077 configurado via PROJ.4 string:"
@echo "+proj=longlat +datum=WGS84 +no_defs"
psql postgres://postgres@localhost/ingest1 -c "DELETE FROM spatial_ref_sys WHERE srid=952077;"
...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952077,'carlos',952077,'+proj=longlat +datum=WGS84 +no_defs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952077"
cd /tmp/sandbox/_pk7600009101_001; shp2pgsql -D   -s 952077 "inscricao_fiscal_cigeo.shp" pk7600009101201_p2_geoaddress | psql -q postgres://postgres@localhost/ingest1 2> /dev/null
...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952077,'carlos',952077,'+proj=longlat +datum=WGS84 +no_defs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952077"
cd /tmp/sandbox/_pk7600009101_001; shp2pgsql -D   -s 952077 "numeroinicioefim1.shp" pk7600009101401_p4_parcel | psql -q postgres://postgres@localhost/ingest1 2> /dev/null
...
psql postgres://postgres@localhost/ingest1 -c "INSERT INTO spatial_ref_sys (srid, auth_name, auth_srid, proj4text, srtext) VALUES (952077,'carlos',952077,'+proj=longlat +datum=WGS84 +no_defs',null);"
psql postgres://postgres@localhost/ingest1 -c "SELECT srid, proj4text FROM spatial_ref_sys where srid=952077"
cd /tmp/sandbox/_pk7600009101_001; shp2pgsql -D -W ISO-8859-1  -s 952077 "axisLine.shp" pk7600009101601_p6_via | psql -q postgres://postgres@localhost/ingest1 2> /dev/null
