...
<tr><td>
Doador: <a rel="external" target="_doador" href="https://www.saobernardo.sp.gov.br/">Prefeitura Municipal de São Bernardo do Campo</a><br/>
<small>cnpj:46.523.239/0001-47</small> • Wikidata <a rel="external" target="_doador" title="link descritor Wikidata do doador" href="https://www.wikidata.org/wiki/Q56449994">Q56449994</a></small><br/>

Obtido via <i>site;email</i> em <b>2020-06-18</b> por:<br/>
...
#### Dados publicados
[http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/nsvia](http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/nsvia)<br/>3428162 bytes (3.27 <abbr title="mebibyte">MiB</abbr>)<br/>33 polígonos com 283.3 <abbr title="quilômetros quadrados">km²</abbr><br/>densidade média: 0.77 polígonos/km²
...
#### Dados publicados
[http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/parcel](http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/parcel)<br/>42131845 bytes (40.18 <abbr title="mebibyte">MiB</abbr>)<br/>127013 polígonos com 204.45 <abbr title="quilômetros quadrados">km²</abbr><br/>densidade média: 0.65 polígonos/km²
...
#### Dados publicados
[http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/via](http://git.digital-guard.org/preservCutGeo-BR2021/tree/main/data/SP/SaoBernardoCampo/_pk0030.01/via)<br/>10949166 bytes (10.44 <abbr title="mebibyte">MiB</abbr>)<br/>4613 segmentos com 1109.75 <abbr title="quilômetros">km</abbr><br/>densidade média: 4.28 segmentos/km²
...
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/22ecd5ef4ca76adef213fa422d9b5e4198f0667df598c511c30e512bb10aaedd.zip
...
psql $(pg_uri_db) -c "DROP  TABLE IF EXISTS pk7600003001101_p1_geoaddress CASCADE"
...
psql $(pg_uri_db) -c "SELECT ingest.publicating_geojsons('geoaddress','BR-SP-SaoBernardoCampo','/var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/geoaddress','2',9,3);"
cd /var/gits/_dg/preserv/src; sudo bash fixaPermissoes.sh /var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/geoaddress
...
mkdir -m 777 -p /tmp/sandbox/_pk7600003001_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/350b605174967b94ef49ce1bbac0352dd76e2175e5eae1b8e5b730cd9950d133.zip
...
psql $(pg_uri_db) -c "DROP  TABLE IF EXISTS pk7600003001401_p4_nsvia CASCADE"
...
psql $(pg_uri_db) -c "SELECT ingest.publicating_geojsons('nsvia','BR-SP-SaoBernardoCampo','/var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/nsvia','1',9,3);"
cd /var/gits/_dg/preserv/src; sudo bash fixaPermissoes.sh /var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/nsvia
...
mkdir -m 777 -p /tmp/sandbox/_pk7600003001_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/d4985405060cc1887962a4278b4d68ada6ffd3ed72f296bd72d65abc4897cd2d.zip
...
psql $(pg_uri_db) -c "DROP  TABLE IF EXISTS pk7600003001201_p2_parcel CASCADE"
...
psql $(pg_uri_db) -c "SELECT ingest.publicating_geojsons('parcel','BR-SP-SaoBernardoCampo','/var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/parcel','1',9,3);"
cd /var/gits/_dg/preserv/src; sudo bash fixaPermissoes.sh /var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/parcel
...
mkdir -m 777 -p /tmp/sandbox/_pk7600003001_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/3269bacc09d450b4d7496a2bc749ece94b1f48462ba0aae70d902404256bc433.zip
...
psql $(pg_uri_db) -c "DROP  TABLE IF EXISTS pk7600003001301_p3_via CASCADE"
...
psql $(pg_uri_db) -c "SELECT ingest.publicating_geojsons('via','BR-SP-SaoBernardoCampo','/var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/via','1',9,3);"
cd /var/gits/_dg/preserv/src; sudo bash fixaPermissoes.sh /var/gits/_dg/preservCutGeo-BR2021/data/SP/SaoBernardoCampo/_pk0030.01/via
