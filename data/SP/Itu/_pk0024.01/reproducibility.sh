...
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org https://dl.digital-guard.org/5041bf52dc6cbd99fb555180a3f34becae8c61352e975f61bfb9c56182e49749.rar
...
psql postgres://postgres@localhost/ingest1 -c "CREATE VIEW vw3_pk7600002401301_p3_building AS SELECT row_number() OVER () as gid, 'yes' AS building, geom FROM $(tabname)"
psql postgres://postgres@localhost/ingest1 -c "SELECT ingest.any_load('shp2sql','/tmp/sandbox/Edificação/Edificação.shp','building_none','vw3_pk7600002401301_p3_building','7600002401301','5041bf52dc6cbd99fb555180a3f34becae8c61352e975f61bfb9c56182e49749.rar',array[]::text[],5,1)"
psql postgres://postgres@localhost/ingest1 -c "DROP VIEW vw3_pk7600002401301_p3_building"
@echo "Confira os resultados nas tabelas ingest.donated_packcomponent e ingest.feature_asis".
psql postgres://postgres@localhost/ingest1 -c "DROP  TABLE IF EXISTS pk7600002401301_p3_building CASCADE"
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002401_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org https://dl.digital-guard.org/00f40e3731f0e04b8d1050a4716385f412aed5b32b560a47cc321ef4ea5413f8.rar
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002401_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org https://dl.digital-guard.org/e10b14c4bfeaa6b40b725acc573a98fba308b72836002af3c7431982b74348f1.rar
