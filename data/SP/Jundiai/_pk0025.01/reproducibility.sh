...
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/512fe4c44525a211c68415da0ab06d565a6ba3653739809d46404d6653ce5064.zip
...
psql postgres://postgres@localhost/ingest1 -c "SELECT ingest.any_load('shp2sql','/tmp/sandbox/_pk7600002501_001/edificacoes.shp','building_none','pk7600002501301_p3_building','7600002501301','512fe4c44525a211c68415da0ab06d565a6ba3653739809d46404d6653ce5064.zip',array['gid', 'geom'],5,1)"
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002501_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/c26c149b65a42e9de131145b8db24aed006f37c5f44c625c835df2fc359f4763.zip
...
psql postgres://postgres@localhost/ingest1 -c "CREATE VIEW vw5_pk7600002501501_p5_geoaddress AS SELECT row_number() OVER () AS gid, numero_int AS hnum, REGEXP_REPLACE(replace(logradouro,'.', ' '), '[[:space:]]+', ' ','g') AS via, bairro AS nsvia, complement, loteamento, cep AS postcode, geom FROM $(tabname)"
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002501_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/7995d41f628e31599f80b367650d363f47e75e1515be9fefabefca91189608a5.zip
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002501_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/4c4a1565e1f7d5675ff2d546d0e6a85acd7bbaa018503601dd07e1be80dee130.zip
...
mkdir -m 777 -p /tmp/sandbox/_pk7600002501_001
mkdir -p /tmp/pg_io
wget -P /var/www/dl.digital-guard.org http://dl.digital-guard.org/062c98c3fc074c76a5ff8d1bb3ad97b120d4a60d2e75c835fd6ff096f466da58.zip
