...
psql postgres://postgres@localhost/ingest1 -c "SELECT ingest.any_load('shp2sql','/tmp/sandbox/_pk7600008401_001/GEO-SOCIAIS ADDRESSFORALL/QUADRAS.shp','block_full','pk7600008401101_p1_block','7600008401101','607ba1a0c854d6c93a0e57a95fa8851be3abe05b292b477ee5eb71ec245b1fae.rar',array['gid', 'num_qdr AS ref', 'geom'],5,1)"
...
psql postgres://postgres@localhost/ingest1 -c "SELECT ingest.any_load('shp2sql','/tmp/sandbox/_pk7600008401_001/GEO-SOCIAIS ADDRESSFORALL/LOTES.shp','parcel_none','pk7600008401101_p1_parcel','7600008401101','607ba1a0c854d6c93a0e57a95fa8851be3abe05b292b477ee5eb71ec245b1fae.rar',array['gid', 'num_lot AS pnum', 'num_qdr AS blref', 'num_bai AS nsref', 'nm_bai AS nsvia', 'geom'],5,1)"
@echo "Confira os resultados nas tabelas ingest.donated_packcomponent e ingest.feature_asis".
psql postgres://postgres@localhost/ingest1 -c "DROP  TABLE IF EXISTS pk7600008401101_p1_parcel CASCADE"
...
psql postgres://postgres@localhost/ingest1 -c "SELECT ingest.any_load('shp2sql','/tmp/sandbox/_pk7600008401_001/GEO-SOCIAIS ADDRESSFORALL/LOGRADOUROS.shp','via_full','pk7600008401101_p1_via','7600008401101','607ba1a0c854d6c93a0e57a95fa8851be3abe05b292b477ee5eb71ec245b1fae.rar',array['gid', 'logradouro as via', 'geom'],5,1)"
@echo "Confira os resultados nas tabelas ingest.donated_packcomponent e ingest.feature_asis".
psql postgres://postgres@localhost/ingest1 -c "DROP  TABLE IF EXISTS pk7600008401101_p1_via CASCADE"
